...
// CarregarPaginaDeCadastroDeUsuario carrega a pagina de cadastros de usuarios
func CarregarPaginaDeCadastroDeUsuario(w http.ResponseWriter, r *http.Request) {
	utils.ExecutarTemplate(w, "cadastro.html", nil)
}

// CarregarPaginaPrincipal renderiza a pagina de publicações
...
// CarregarPaginaDeusuarios carrega a página de usuários que atendem o filtro passado
...
// CarregarPaginaDeEdicaoDeUsuario carrega a página de edição dos dados do usuário logado
...
// CarregarPaginaDeAtualizacaoDeSenha carrega a página de atualizaçao de senha dos usuários
