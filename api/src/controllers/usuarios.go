...
import (
	...
	"api/src/banco"
	"api/src/modelos"
	repositorios "api/src/repositorios"
	"api/src/respostas"
	"api/src/seguranca"
	"encoding/json"
	"errors"
...
// BuscaUsuario busca um usuário no Banco de Dados
...
// DeletarUsuario escluirá as informações de um usuário no Banco de Dados
...
// Seguir usuario permite que um usuario siga outro
...
// PararDeSeguir usuario permite que um usuario deixe de seguir outro
...
// AtualizarSenha permite alterar a senha de um usuário no BD
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível atualizar a senha de um usuário que não seja você mesmo"))
		return
	}
